...
class RobotServer():
    def __init__(self,robot:Robot,server_ip:str='192.168.0.114'):
    ...
    def listen_from_client(self,client_address:str='192.168.0.160'):
        try:            
